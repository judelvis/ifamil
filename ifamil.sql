...
-- Volcando estructura para tabla ifamil.t_contactos
...
-- Volcando datos para la tabla ifamil.t_contactos: ~1 rows (aproximadamente)
...
INSERT INTO `t_noticias` (`oid`, `imagen`, `titulo`, `descrip`, `enlace`, `fecha`, `resumen`, `modificado`) VALUES
	...
	(4, 'pagina1.jpg', 'IFAMIL SITIO WEB', 'Un sitio web fácil y accesible, para que los usuarios realicen sus reservaciones tanto de vuelos como de paquetes turísticos todo a su alcance. <br><br> \r\nNuestra Agencia de Viajes cuenta con 35 años de Experiencia comprobada en el gremio Turístico Nacional, poseemos un recurso humano calificado con gran experiencia en viajes de placer y viajes de negocios, además hemos ampliado nuestra red de comercialización con la finalidad de ofrecer a nuestra clientela una extensa gama de productos y servicios.\r\n<br><br>\r\nQue esperas AFILIATE YA para que disfrutes de nuestros servicios.', '', '2015-09-14', 'Una forma más de comunicarte con nosotros.', '2015-09-14 16:38:54');
/*!40000 ALTER TABLE `t_noticias` ENABLE KEYS */;


-- Volcando estructura para tabla ifamil.t_opinion
...
-- Volcando datos para la tabla ifamil.t_opinion: ~1 rows (aproximadamente)
