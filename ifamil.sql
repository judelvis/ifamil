...
-- Dumping data for table ifamil.t_noticias: ~5 rows (approximately)
...
INSERT INTO `t_noticias` (`oid`, `imagen`, `titulo`, `descrip`, `enlace`, `fecha`, `resumen`, `modificado`, `titulo_i`, `descrip_i`, `resumen_i`) VALUES
	...
	(3, 'cumple.jpg', 'IFAMIL CELEBRA LOS CUMPLEAÑOS DEL MES', 'Caracas 28 de agosto de 2015.- Una vez más IFAMIL realza a sus empleados. En esta oportunidad celebrando los cumpleaños del mes. Los mismos, con una gran sonrisa, expresaron su alegría y  gratitud, por este gesto tan maravilloso, ya que es la celebración de un año más de vida lleno de salud y bendiciones que le regala Dios.', '', '2015-08-28', 'Cumpleaños del mes de Agosto.', '2015-09-14 08:43:35', '', '', ''),
	(4, 'pagina1.jpg', 'IFAMIL SITIO WEB', 'Un sitio web fácil y accesible para el usuario, para que realicen sus reservaciones tanto de vuelos como de paquetes turísticos todo a su alcance. <br><br> Afiliate...', '', '2015-09-14', 'Una forma más de comunicarte con nosotros.', '2015-09-14 16:35:10', '', '', ''),
	(5, 'noticia2.jpg', 'Noticia nueva', 'Detalle Noticia nueva', '', '2015-09-16', 'resumen noticia nueva', '2015-09-16 19:58:27', 'title new inles', 'detail new ingles', 'resumen ingles nueva');
...
-- Dumping data for table ifamil.t_opinion: ~1 rows (approximately)
...
-- Dumping data for table ifamil.t_portafolio: ~4 rows (approximately)
...
INSERT INTO `t_portafolio` (`id`, `oidcat`, `titulo`, `descrip`, `resumen`, `fecha`, `modificado`, `estatus`, `titulo_i`, `descrip_i`, `resumen_i`) VALUES
	...
	(7, 2, 'Paquete Espanol', 'Descripcion Paquete Espanol', 'Resumen paquete espanol', '2015-09-16', '2015-09-16 20:38:59', 0, 'Packac Name', 'Descrip Pack', 'Resumen Packac');
