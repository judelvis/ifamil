...
if (isset($_SESSION['idioma']) && $_SESSION['idioma'] == '_i') {
    $t = "Services";
    $p = 'Our Travel Agency has 35 years of experience in the National Tourist, we have specialized people with extensive experience in tourism and business travel, we also expanded our marketing network with the purpose to offer our customers an extensive range of products and services.';
    $t2 = 'TRAVEL SERVICES WE OFFER';
...
';
    $s3 = '   Rentals car at National and International Level.
';
    $s4 = '    Advice and sale of national and international packages , Full Days , tours , package Quinceañeras, Cruises, travel gold , Travel Graduation.
';
    $s5 = '    we organize trips in group , conventions and congresses with expertise.
';
...
';
    $s10 = '    We offer our clients security service night ,View Weekends, and holidays.
';
...
';
    $s12 = '    We rent Party Hall Use Only "El Mirador" . Strategically located in IPSFA Facilities with capacity para 350 persons.
';
...
';
    $s14 = '    We organize Vacations Plans and Campgrounds.
';
} ?>
        ...
        <div class="blog"><!-- start blog -->
            <div class="blog_main col-md-9">
                ...
                <div class="col-md-12 span1_of_3">
                    <ul class="para">
                        <br>
                        <li><a href="<?php echo base_url("index.php/Principal/contacto") ?>"> <?php echo $s1; ?></a>
                        </li>
                        <br>
                        <li><a href="<?php echo base_url("index.php/Principal/contacto") ?>"><?php echo $s2; ?></a></li>
                        <br>
                        <li><a href="<?php echo base_url("index.php/Principal/contacto") ?>"> <?php echo $s3; ?></a>
                        </li>
                        <br>
                        <li><a href="<?php echo base_url("index.php/Principal/contacto") ?>"> <?php echo $s4; ?></a>
                        </li>
                        <br>
                        <li><a href="<?php echo base_url("index.php/Principal/contacto") ?>"> <?php echo $s5; ?></a>
                        </li>
                        <br>
                        <li><a href="<?php echo base_url("index.php/Principal/contacto") ?>"> <?php echo $s6; ?></a>
                        </li>
                        <br>
                        <li><a href="<?php echo base_url("index.php/Principal/contacto") ?>"> <?php echo $s7; ?></a>
                        </li>
                        <br>
                        <li><a href="<?php echo base_url("index.php/Principal/contacto") ?>"> <?php echo $s8; ?></a>
                        </li>
                        <br>
                        <li><a href="<?php echo base_url("index.php/Principal/contacto") ?>"> <?php echo $s9; ?></a>
                        </li>
                        <br>
                        <li><a href="<?php echo base_url("index.php/Principal/contacto") ?>"> <?php echo $s10; ?></a>
                        </li>
                        <br>
                        <li><a href="<?php echo base_url("index.php/Principal/contacto") ?>"> <?php echo $s11; ?></a>
                        </li>
                        <br>
                        <li><a href="<?php echo base_url("index.php/Principal/contacto") ?>"> <?php echo $s12; ?></a>
                        </li>
                        <br>
                        <li><a href="<?php echo base_url("index.php/Principal/contacto") ?>"> <?php echo $s13; ?></a>
                        </li>
                        <br>
                        <li><a href="<?php echo base_url("index.php/Principal/contacto") ?>"> <?php echo $s14; ?></a>
                        </li>
